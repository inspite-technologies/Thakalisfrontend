    ...
    try {
      ...
      if (searchQuery) {
        if (selectedShop !== 'all') {
          ...
          url = `${API_BASE_URL}/stores/products/search`;
          params.append('search', searchQuery);
          // storeRoutes searchProductsByStore uses 'storeId' from query if not vendor
          // It's already appended above
        } else {
          // Global search - Use client-side filtering workaround
          url = `${API_BASE_URL}/products`;
          // We don't append 'search' here because /products doesn't support it
          // We will filter the results below
          // Use a higher limit to ensure we get enough results to filter
                  ...
                  >
                    ...
                    <div className="p-4">
                      ...
                      <div className="flex items-center justify-between mb-2">
                        ...
                        {isLoggedIn && findQuantity(product.id) > 0 ? (
